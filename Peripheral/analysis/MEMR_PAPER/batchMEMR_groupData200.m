function [] = batchMEMR_groupData200()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% batchMEMR_groupData
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dataPathName = [parentDrive,':\MEMR_Analysis200\']; % location of raw data
    savePath = [parentDrive,':\MEMR_GroupData200\']; % where to save analyzed data
