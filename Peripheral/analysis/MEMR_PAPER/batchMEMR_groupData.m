...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dataPathName = [parentDrive,':\MEMR_Analysis_Fix1\']; % location of raw data
    savePath = [parentDrive,':\MEMR_GroupData_Fix1\']; % where to save analyzed data
