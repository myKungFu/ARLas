function [C_inc,C_mem] = analyzeMEMR_vmepani2(header,Clicks,headerN,Noise,subjectName)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % analyze MEMR --------------------------------------------------------
    stabilityCheck = 0;
    C_mem = runme(Clicks,nClicks,indx,time,fs,stabilityCheck,subjectName);
    % analyze ear canal stability
    stabilityCheck = 1;
    C_inc = runme(Clicks,nClicks,indx,time,fs,stabilityCheck,subjectName);
...
% INTERNAL FUNCTIONS ------------------------------------------------------
function [C] = runme(Clicks,nClicks,indx,time,fs,stabilityCheck,subjectName)
