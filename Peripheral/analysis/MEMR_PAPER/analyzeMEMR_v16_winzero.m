function [MEMR_inc,MEMR_mem,h1] = analyzeMEMR_v16_winzero(header,Clicks,headerN,Noise,subjectName,runNumber)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [MEMR] = runme(Clicks,nClicks,indx,time,fs,stabilityCheck,subjectName,runNumber)
    ...
    % Window all clicks and save into a matrix C --------------------------
        ...
        % 8-12 samples
    winN = 1; % number of samples to reduce (before reflection comes back)
