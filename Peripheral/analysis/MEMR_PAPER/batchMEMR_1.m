...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    savePath = [parentDrive,':\MEMR_Analysis_Fix1\']; % where to save analyzed data
    ...
    for ii=1:nSubjects
        ...
        for jj=1:nRuns
            ...
            [MEMR_inc,MEMR_mem,h1] = analyzeMEMR_v16(header,Clicks,headerN,Noise,folderName,runNumber);
              % [MEMR_inc,MEMR_mem,h1] = analyzeMEMRabs_v16(header,Clicks,headerN,Noise,folderName,runNumber);
