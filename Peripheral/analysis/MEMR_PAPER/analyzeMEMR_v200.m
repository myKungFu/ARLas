function [MEMR_inc,MEMR_mem,h1] = analyzeMEMR_v200(header,Clicks,headerN,Noise,subjectName,runNumber)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [MEMR] = runme(Clicks,nClicks,indx,time,fs,stabilityCheck,subjectName,runNumber)
    ...
    fmin = 200; % minimum frequency to analyze (Hz)
    fmax = 200; % maximym frequency to analyze (Hz)
...
d1 = d2;   % This is a hack to just look at magnitude, change this later iof you want to include both phase and mag
