...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    savePath = [parentDrive,':\MEMR_Analysiswinzero\']; % where to save analyzed data
    ...
    for ii=1:nSubjects
        ...
        for jj=1:nRuns
            ...
            [MEMR_inc,MEMR_mem,h1] = analyzeMEMR_v16_winzero(header,Clicks,headerN,Noise,folderName,runNumber);
