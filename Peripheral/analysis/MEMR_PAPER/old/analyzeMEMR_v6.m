function [MEMR] = analyzeMEMR_v6(pathName,fileNameL,fileNameR,subjectName,runName)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [h10,h11] = analyzeMEMR_v6()
% (Data,time,fs,indx)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fmin = 125; %250; % minimum frequency to examine
...
% location of noise levels
    ...
    MEMR = runme(Data,nSamples,nClicks,indx,time,fs,peakFreqs,noiseLvl,noiseRate,...
        subjectName,runName,elicitor,pathName,fileNameL,fileNameR);
    %keyboard
end
% INTERNAL FUNCTIONS ------------------------------------------------------
function [MEMR] = runme(Data,nSamples,nClicks,indx,time,fs,peakFreqs,noiseLvl,noiseRate,...
    subjectName,runName,elicitor,pathName,fileNameL,fileNameR)
