function [MEMR] = analyzeMEMR_v14(pathName,subjectName,runNumber)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [MEMR] = analyzeMEMR_v4(pathName,subjectName,runNumber)
%
...
function [analysisPart1] = runme(Clicks,nSamples,nClicks,indx,time,fs,peakFreqs,noiseLvl,noiseRate,...
    ...
    if stabilityCheck == 1
        ...
        for ii=1:nClicks % loop across each click position (1-160)
            ...
            %[pl,Pl,phi,other,wf] = ARLas_convertPL(mean(q,2),header.userInfo.iscS1L);
            %zl = other.ZL;
            qn = Clicks(indx(ii)+1000:indx(ii)+1000+clickN-1,:); % window for noise estimate
 ...
 %    pause(0.01)
    ...
    CFTn = CFT; % initialize noise matrix
