function [h10,h11] = analyzeMEMR_v2(DataL,time,fs,indx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [h10,h11] = analyzeMEMR_v2(DataL,time,fs,indx)
%
% Author: Shawn Goodman
% Date: August 6, 2022
% Last Updated: August 9, 2022
% Last Updated: October 10, 2022 -- ssg -- version 2; goest with
%                       goodmanMEMR_v2.m.
...
%     end
    MEMR = runme(template,Data,nSamples,nClicks,indx,time,fs,iscS1L);


end
% INTERNAL FUNCTIONS ------------------------------------------------------

function [h10,h11] = runme(template,Data,nSamples,nClicks,indx,time,fs,iscS1L,offset)
%     tic
