function [] = goodmanMEMR_v1(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% goodmanMEMR_v1(varargin)
%
% Measure MEMR, Goodman method.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    V = '08JUL2022'; % this is the current version number of this program
...
% specify calibration to use to set stimulus levels
    ...
    if strcmp(calType,'thev')
        ...
        error('Unrecognized calibration type. Aborting memr program.')
    end
    ...
    % create stimuli
    [nLoops,clickTrain,noiseSamples,nReps,H] = getStimuli(obj);
...
%                 Y1 = clickTrain;
%                 [rows,cols] = size(Y1);
%                 [S1L,clicksImpulse,errors1] = ARLas_applyISC(iscS1L,targetL1(ii)+adjust,targetCalType,clickTrain(:),Y1(:));
...
nLoops = 1;
    for ii=1:nLoops
        ...
        % generate loopDuration seconds of noise
        ...
        multiplierNoise = 0.95;
        Noise = Noise * multiplierNoise;
        
        indx = find(clickTrain>.01);
...
% INTERNAL FUNCTIONS ------------------------------------------------------
function [nLoops,clickTrain,noiseSamples,nReps,H] = getStimuli(obj)
    ...
    loopDuration = 240; %60; % seconds per loop
