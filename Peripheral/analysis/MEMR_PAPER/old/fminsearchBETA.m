function [obj,fval,exitflag,output] = fminsearchBETA(funfcn,obj,options,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [obj,fval,exitflag,output] = fminsearchBETA(funfcn,obj,options,varargin)
%
% This function searches for the best values of A and B for a beta
% function as the fit to signal in noise ablations. For use with Jeff
% Litchenhan's guinea pig data.
%
...
% Change the code here so that input can be an object. Assume this is
% being used for beta distribution fitting, so that optimization is for A and B.
x = [obj.A;obj.B]; % A and B coefficients
% ----------------------------------------------
