function [] = batchMEMR_groupDatawinzero()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% batchMEMR_groupData
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dataPathName = [parentDrive,':\MEMR_Analysiswinzero\']; % location of raw data
    savePath = [parentDrive,':\MEMR_GroupDatawinzero\']; % where to save analyzed data
