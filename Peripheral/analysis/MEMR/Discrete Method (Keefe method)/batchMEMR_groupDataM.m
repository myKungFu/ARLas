...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dataPathName = [parentDrive,':\myWork\ARLas\MEMR_Analysis_Final_M\']; % location of raw data
    savePath = [parentDrive,':\myWork\ARLas\MEMR_Data_Final\']; % where to save analyzed data
...
try 
    ...
    % extract data as a row vector
        ...
        X(ii,14) = median(MEMR_mem.pSPL.'); % peak spl of clicks
        X(ii,15) = max(MEMR_mem.RMS).'; % rms elicitor levels (max)
catch ME
    keyboard
end
    ...
    saveName = [savePath,'MEMR_groupDataM.mat'];
