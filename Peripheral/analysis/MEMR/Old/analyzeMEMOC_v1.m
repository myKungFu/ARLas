function [MEMR_inc,MEMR_mem,MEMR_moc,h1,h2] = analyzeMEMOC_v1(header,Clicks,headerN,Noise,subjectName,runNumber)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [MEMR_inc,MEMR_mem,h1] = analyzeMEMOC_v1(header,Clicks,headerN,Noise,subjectName,runNumber)
%
