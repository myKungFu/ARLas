...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    load('C:\myWork\ARLas\MEMR_Analysis_Final_15\MEM06_Run2_Analysis1.mat')
    D = MEMR_mem.D(:,5:15);
    plot(D(:,7),'.-','Color',[1 0 0],'LineWidth',0.5,'MarkerSize',8)
    plot(D(:,8),'.-','Color',[0 0 1],'LineWidth',0.5,'MarkerSize',8)
    load('C:\myWork\ARLas\MEMR_Analysis_Final_15\MEM06_Run3_Analysis1.mat')
    D = MEMR_mem.D(:,5:15);
    plot(D(:,7),'.-','Color',[1 0 0],'LineWidth',0.5,'MarkerSize',8)
    plot(D(:,8),'.-','Color',[0 0 1],'LineWidth',0.5,'MarkerSize',8)
    load('C:\myWork\ARLas\MEMR_Analysis_Final_15\MEM06_Run4_Analysis1.mat')
    D = MEMR_mem.D(:,5:15);
    plot(D(:,7),'.-','Color',[1 0 0],'LineWidth',0.5,'MarkerSize',8)
    plot(D(:,8),'.-','Color',[0 0 1],'LineWidth',0.5,'MarkerSize',8)
