...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [fileDir, fileName, fileExt] = fileparts(FN);

    % Define variations as new filenames (Run2, Run3, Run4)
    FN2 = fullfile(fileDir, [strrep(fileName, 'Run1', 'Run2'), fileExt]);
    FN3 = fullfile(fileDir, [strrep(fileName, 'Run1', 'Run3'), fileExt]);
    FN4 = fullfile(fileDir, [strrep(fileName, 'Run1', 'Run4'), fileExt]);
