function [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc] = ARLas_dpoaeStim_fixedRatioContinuous_v1(fs,fmin,fmax,sweepRate,targetL1,targetL2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc] = ARLas_dpoaeStim_fixedRatioContinuous_v1(fs,fLow,fHigh);
%
% Create two vectors of DPOAE stimuli, f1 and f2.
% The vectors are then folded into matrices for efficiency presenting
% through ARLas; goes with ARLas_dpoae_fixedRatioContinuous_v1.m.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [f1,fdp,fRatio] = getRatios(targetL1,targetL2,f2);
        ...
        % the following was original for fixed fRatio
        %fRatio = 1.22; % f2/fs ratio
