function [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc,L2] = ARLas_dpoaeStim_sweepL2Continuous_v1(fs,f1,L2min,L2max,sweepRate,targetL1,fRatio)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc] = ARLas_dpoaeStim_sweepL2Continuous_v1(fs,f1,ratioMin,ratioMax,sweepRate,targetL1,targetL2);
%
