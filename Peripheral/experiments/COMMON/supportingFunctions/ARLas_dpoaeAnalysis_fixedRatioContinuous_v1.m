function [DPOAE,DPOAE_ref] = ARLas_dpoaeAnalysis_fixedRatioContinuous_v1(header,Data,DPOAE,RefData)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [DPOAE,DPOAE_ref] = ARLas_dpoaeAnalysis_fixedRatioContinuous_v1(header,Data,DPOAE,RefData);
%
