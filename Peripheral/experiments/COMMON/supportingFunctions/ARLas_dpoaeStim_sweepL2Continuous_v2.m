function [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc,L2] = ARLas_dpoaeStim_sweepL2Continuous_v2(fs,f1,L2min,L2max,sweepRate,targetL1,fRatio)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc] = ARLas_dpoaeStim_sweepL2Continuous_v2(fs,f1,ratioMin,ratioMax,sweepRate,targetL1,targetL2);
%
...
% Last Updated: July 21, 2022 -- ssg -- using Sami Ginter's ratios
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dB = linspace(0,nDB,N)'; % dB spacing
    L2 = 10.^(dB/20)*0.00002; % put into linear space.
    ...
    N = length(L2); % recalculate new number of samples
