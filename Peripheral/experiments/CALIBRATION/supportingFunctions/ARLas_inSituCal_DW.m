function [isc] = ARLas_inSituCal_DW(obj,recording,stimulus)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [isc] = ARLas_inSituCal_DW(obj,recording,stimulus);
%
...
% This version (_DW) is for use with the Lichtenhan lab and guinea pig ear
% bar. It does not estimate the ear canal diameter, but rather uses the
% known diameter of 0.3 cm.
%
...
% Date: December 1, 2017 (original version)
% Updated: October 16, 2018
% Updated: July 9, 2019 -- ssg & sb; added phase outputs
% Updated: February 5, 2020 -- ssg
%                              This new version (_DW) uses a fixed ear
%                              canal (ear bar diameter of 0.3 cm.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
diam = 0.3; % the ear bar is a fixed diameter of 0.3 cm
z0 = 395; % impedance using this fixed diameter
...
function diam = getDiameter(z0)
    % get cavity diameter, based on calculated surge impedance (z0)
    a = 1.219;  
    b = -0.03033 ; 
    c = 0.8667 ;
    d = -0.002683 ; 
