function [] = ARLas_cavityRecordings_ER10x(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ARLas_cavityRecordings_ER10x(varargin);
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    obj = varargin{1};
    params = varargin{2};
    V = '07.05.2021'; % this is the current version number of this program
    ...
    if params.outputLimiterEnabled == 0 % if limiter is disabled, 
        stimGain_dB = stimGain_dB -15; % reduce output by another 15 dB
    end
