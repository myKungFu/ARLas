function [] = ARLas_calibrationRoutine_ER10x(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ARLas_calibrationRoutine_ER10x(varargin);
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    obj = varargin{1};
    V = '19OCT2022'; % this is the current version number of this program
...
%--------------------------------------------------------------------------
    ...
    which10X = 'SG'; % Specify which ER10X probe Microphone to "calibrate".
...
% 2. Perform Thevenin source calibration on the 10X WITH mic correction, if it exists.
    if doThevCal == 1
        ...
        ARLas_cavityRecordings_ER10x(obj,params) % perform Thevenin calibration
