function [h] = DW_plotAudiogram12Clicks(frequency,magnitude,h)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% h = DW_plotAudiogram12Clicks(frequency,magnitude,h);
%
...
% Updated: July 26, 2017 ssg
% Updated: November 7, 2019 ssg
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

fmin = 100; % minumum frequency (Hz)
fmax = 32000; % maximum frequency (Hz)
ymin = -90;
ymax = -30;
niceTicks = [100, 250, 500, 1000, 1250, 1600, 2000, 2500, 3150, 4000, 5000,...
...
figure(h)
hold on
nClicks = size(magnitude,2);
for ii=1:nClicks
    plot([logX(ii,1);logX(ii,2)],[magnitude(ii);magnitude(ii)],'LineWidth',2);
    indx = find(isnan(magnitude(ii)));
    nnan = length(indx);
    if nnan >= 1
    %    for jj=1:nnan
        plot([logX(ii,1);logX(ii,2)],[ymax;ymax],'xk');
    %    end
    end
end
