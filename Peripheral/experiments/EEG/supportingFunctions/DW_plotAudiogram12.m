function [h] = DW_plotAudiogram12(frequency,magnitude,h)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% h = DW_plotAudiogram12(frequency,magnitude,h);
%
...
plot(logX,magnitude,'*-k');
hold on
indx = find(isnan(magnitude));
nnan = length(indx);
if nnan >= 1
    for ii=1:nnan
        plot(logX(indx(ii)),100,'xk');
    end
end
% %
