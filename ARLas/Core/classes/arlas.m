...
%                       version control
% Last Updated: April 4, 2024 -- ssg -- changed the output limiter to
% always be zero (for IHS system there is no output limiter).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function initGui(varargin) % initialize the arlas graphical user interface
        ...
        try % create new main figure
            ...
            try
                ...
                extra.outputLimiter = 0;
% This version is for the IHS system. There is no output limiter here.                
