function [DPOAE,DPOAE_ref] = ARLas_dpoaeAnalysis_fixedF1Continuous_v1(header,Data,DPOAE,RefData)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [DPOAE,DPOAE_ref] = ARLas_dpoaeAnalysis_fixedF1Continuous_v1(header,Data,DPOAE,RefData);
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    stepSize = 16; % 12 max, 6 min in a good range; original at 8 for fixed ratio
    jj = 1;
