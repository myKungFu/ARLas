function [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc] = dpoaeStim_v5(fs,fmin,fmax,sweepRate,targetL1,targetL2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [Y1,Y2,F1,F2,Fdp,Time,Y1c,Y2c,Ydp,Ydpc] = dpoaeStim_v5(fs,fLow,fHigh);
%
...
% Last Updated: September 9, 2021 -- ssg -- changed to v5 to bring in line
%               with current verisions of other programs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
