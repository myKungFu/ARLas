function [DPOAE,DPOAE_ref] = ARLas_dpoaeAnalysis_sweepL2Continuous_v9(header,Data,DPOAE,RefData)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [DPOAE,DPOAE_ref] = ARLas_dpoaeAnalysis_sweepL2Continuous_v9(header,Data,DPOAE,RefData);
%
