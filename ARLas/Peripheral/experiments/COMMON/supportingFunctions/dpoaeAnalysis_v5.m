function [DPOAE,DPOAE_ref] = dpoaeAnalysis_v5(header,Data,DPOAE,RefData)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [DPOAE,DPOAE_ref] = dpoaeAnalysis_v5(header,Data,DPOAE,RefData);
%
% Analyze swept DPOAE recordings; goes with dpoae_v5.m.
%
% Author: Shawn S. Goodman
% Date: June 30, 2021
% Last Updated: July 2, 2021 -- ssg
% Last Updated: July 5, 2021 -- ssg
% Last Updated: July 11, 2021 -- ssg
% Last Updated: July 31, 2021 -- ssg -- extended the filter cutoffs
% Last Updated: August 19, 2021 -- ssg -- added stimulus level verification (ref)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
