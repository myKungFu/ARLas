...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if isempty(map)
        if strcmp(calType,'thev')
            pathName = ['C:',fsep,'myWork2',fsep,'ARLas',fsep,'Peripheral',fsep,'calibrations',fsep,'thevCals',fsep];
            tag = [probeLabel,'_Ch',num2str(probeCh),'_'];
        elseif strcmp(calType,'mic')
            pathName = ['C:',fsep,'myWork2',fsep,'ARLas',fsep,'Peripheral',fsep,'calibrations',fsep,'micCals',fsep];
